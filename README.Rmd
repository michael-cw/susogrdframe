...
* Make sure the *devtools* package is installed, if not install it with *install.packages("devtools")*
...
In case R prompts you to update/install any addtional packages, please confirm, ideally with update all. This may take a while, however these packages are required to run the application.
